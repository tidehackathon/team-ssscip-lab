...
text_test = ['this is such an amazing movie! I like it. My girl hate it instead']
...
def test_preprocess_model(bert_preprocess_model):
...
if __name__ == '__main__':
    train_ds, val_ds, test_ds = prepare_imdb()
